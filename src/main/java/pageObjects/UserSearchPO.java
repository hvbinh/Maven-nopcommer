...
public class UserSearchPO extends AbstractPage{
	...
	public void uncheckSubCategoryCheckbox() {
		waitToElementClickable(driver, UserSearchPageUI.SUB_CATEGORY_CHECKBOX);
		uncheckToCheckbox(driver, UserSearchPageUI.SUB_CATEGORY_CHECKBOX);
	}

	public void checkSubCategoryCheckbox() {
		waitToElementClickable(driver, UserSearchPageUI.SUB_CATEGORY_CHECKBOX);
		checkToCheckbox(driver, UserSearchPageUI.SUB_CATEGORY_CHECKBOX);
	}
