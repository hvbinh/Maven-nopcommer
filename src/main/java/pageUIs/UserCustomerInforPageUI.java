...
public class UserCustomerInforPageUI {
	...
	public static final String ADDRESS_SAVE_BUTTON = "//button[contains(@class,'save-address-button')]";
	...
	public static final String CHANGE_PASSWORD_RESULT_MESSAGE = "//div[@class='bar-notification success']/p";
	...
	public static final String SEARCH_BUTTON = "//button[contains(@class,'search-box-button')]";
	...
	public static final String REVIEW_SUBMIT_BUTTON = "//button[contains(@class,'write-product-review-button')]";
